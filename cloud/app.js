...
app.use(express.basicAuth('hareut', 'hk1234'));

function renderAll(req, res, message, clicked_messages, installations, messages_sent){
	console.log('renderAll() started');
    res.render('hareut_karmiel', { message: message, clicked_messages: clicked_messages, installations: installations, sent_messages: messages_sent});
}

function renderChangePassword(req, res, message){
    console.log('renderChangePassword() started');
    res.render('hk_change_password', { message: message});
}

app.get('/hareut_karmiel', function(req, res) {
	//setSchoolChannel();
...
app.get('/hk_change_password', function(req, res) {
    //setSchoolChannel();
    //getPassword("hareutKarmiel").then(function(result) {
    res.render('hk_change_password', { message: "", url: "", channel: "", password: "", passwordMessage: "" });
    //});
});
...
app.post('/hareut_karmiel', function(req, res) {
...
app.post('/hk_change_password', function(req, res) {
